...
import { TextField, Button, Dialog, DialogActions, DialogContent, DialogTitle, Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Tooltip } from '@mui/material';
import { useDispatch, useSelector } from 'react-redux';
import { fetchPersonals, updatePersonal, addPersonal, selectPersonals, addPersonaldetail, updatePersonaldetail } from '@/features/account-setting/personalSlice';
      ...
      <AccountSettingsPage />
        <Box style={{ padding: '2px' }} sx={{ ml: 2 }}>
          ...
          {loading ? (
            ...
            personalitems
              .filter((personal) => personal && personal.personName && personal.email && personal.phoneNo)
              .map((personal) => (
                <TableContainer
                  component={Paper}
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          <Typography variant="body1">{personal.personName}</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell variant="head">
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <Typography variant="body1">{personal.phoneNo}</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
          ...
          <Dialog open={openDialog} onClose={handleCloseDialog}>
            <DialogTitle>{selectedPersonal ? 'Edit Personal Info' : 'Add Personal Info'}</DialogTitle>
            <DialogContent>
              <Formik
                initialValues={{
