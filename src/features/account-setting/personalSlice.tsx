...
export const fetchPersonals = createAsyncThunk('personals/fetchPersonals', async () => {
  const response = await axios.get('http://192.168.29.116:8000/purchaseapi/popersonals/'); // Adjust API endpoint as needed
...
export const addPersonal = createAsyncThunk<Personal, Personal>('personals/addPersonal', async (personalData) => {
  const response = await axios.post('http://192.168.29.116:8000/purchaseapi/popersonals/', personalData); // Adjust API endpoint as needed
  return response.data;
});
...
export const updatePersonal = createAsyncThunk<Personal, Personal>('personals/updatePersonal', async (personalData) => {
  const response = await axios.patch(`http://192.168.29.116:8000/purchaseapi/popersonals/${personalData.personalId}`, personalData); // Adjust API endpoint as needed
  return response.data;
});
