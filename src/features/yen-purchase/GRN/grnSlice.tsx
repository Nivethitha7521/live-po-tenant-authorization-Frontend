...
export const fetchRandomNumbers = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get<PurchaseRandomId[]>('http://192.168.1.122:8000/purchaseorders/getByRandomId');
...
export const fetchReturnReasons = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get<ReturnReason[]>('http://192.168.1.122:8000/grns/getgrn/return-reasons');
...
export const addReturnReason = createAsyncThunk(
  ...
  async (reason: string, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://192.168.1.122:8000/grns/return-reasons', { reason });
...
export const returnGrn = createAsyncThunk(
  ...
  async (payload: { grnId: string; returnData: ReturnGRNRequest }, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`http://192.168.1.122:8000/grns/${payload.grnId}/return`, payload.returnData);
      return response.data;
    } catch (error: any) {
...
>(
  ...
  async ({ grnId, page, size }, { rejectWithValue }) => {
    try {
      const response = await axios.get<DebitCreditNote[]>(`http://192.168.1.122:8000/grns/returnprocess/DebitNote/${grnId}`, {
...
//       const response = await axios.get('http://192.168.1.122:8000/grns/from-date/', {
//         params: params,
//       });
...
export const updateGrnCancelStatus = createAsyncThunk(
  ...
  async (grnId: string, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.patch(`http://192.168.1.122:8000/grns/${grnId}`, {
        status: 'active',
      });
