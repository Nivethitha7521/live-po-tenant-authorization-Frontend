...
export const fetchRandomNumbers = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get<PurchaseRandomId[]>('http://192.168.29.116:8000/purchaseapi/purchaseorders/getByRandomId');
...
export const fetchReturnReasons = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get<ReturnReason[]>('http://192.168.29.116:8000/purchaseapi/grns/getgrn/return-reasons');
...
export const addReturnReason = createAsyncThunk(
  ...
  async (reason: string, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://192.168.29.116:8000/purchaseapi/grns/return-reasons', { reason });
...
export const returnGrn = createAsyncThunk(
  ...
  async (payload: { grnId: string; returnData: ReturnGRNRequest }, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`http://192.168.29.116:8000/purchaseapi/grns/${payload.grnId}/return`, payload.returnData);
      return response.data;
    } catch (error: any) {
...
>(
  ...
  async ({ grnId, page, size }, { rejectWithValue }) => {
    try {
      const response = await axios.get<DebitCreditNote[]>(`http://192.168.29.116:8000/purchaseapi/grns/returnprocess/DebitNote/${grnId}`, {
...
//       const response = await axios.get('http://192.168.29.116:8000/purchaseapi/grns/from-date/', {
//         params: params,
//       });
...
export const updateGrnCancelStatus = createAsyncThunk(
  ...
  async (grnId: string, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.patch(`http://192.168.29.116:8000/purchaseapi/grns/${grnId}`, {
        status: 'active',
      });
