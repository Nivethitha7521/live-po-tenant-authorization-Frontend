...
export const addPurchaseGroupItem = createAsyncThunk<PurchaseGroupItem, Omit<PurchaseGroupItem, 'itemgroupId'>>(
  ...
  async (groupItemData, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://yenerp.com/purchasetestapi/itemgroups/', groupItemData);
      return response.data;
    } catch (error: any) {
  ...
  async (groupItemData, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        `https://yenerp.com/purchasetestapi/itemgroups/${groupItemData.itemgroupId}`,
        groupItemData
      );
      return response.data;
    } catch (error: any) {
...
export const deactivatePurchaseGroupItem = createAsyncThunk<PurchaseGroupItem, string>(
  ...
  async (itemgroupId, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`https://yenerp.com/purchasetestapi/itemgroups/${itemgroupId}`, {
        status: 'deactivated',
      });
      return response.data;
    } catch (error: any) {
...
export const exportCSV = createAsyncThunk('purchaseGroupItems/exportCSV', async (_, { rejectWithValue }) => {
  try {
    const response = await axios.get('https://yenerp.com/purchasetestapi/itemgroups/export-csv', {
      responseType: 'blob',
    });
