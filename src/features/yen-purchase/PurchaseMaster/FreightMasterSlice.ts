...
export const fetchFreightItems = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get<Freight[]>('https://yenerp.com/purchasetestapi/freights/');
...
export const addFreightItem = createAsyncThunk<Freight, Omit<Freight, 'freightId'>>(
  ...
  async (freightData, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://yenerp.com/purchasetestapi/freights/', freightData);
      return response.data;
    } catch (error: any) {
  ...
  async (freightData, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        `https://yenerp.com/purchasetestapi/freights/${freightData.freightId}`,
        freightData
      );
      return response.data;
    } catch (error: any) {
...
export const deactivateFreightItem = createAsyncThunk<Freight, string>(
  ...
  async (freightId, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`https://yenerp.com/purchasetestapi/freights/${freightId}`, {
        status: 'deactivated',
      });
      return response.data;
    } catch (error: any) {
...
export const importCSV = createAsyncThunk<ImportResult, File>(
  ...
  async (file: File, { rejectWithValue }) => {
    ...
    try {
      ...
      const response = await axios.post('https://yenerp.com/purchasetestapi/freights/import-csv', formData, {
...
export const exportCSV = createAsyncThunk('freightItems/exportCSV', async (_, { rejectWithValue }) => {
  try {
    const response = await axios.get('https://yenerp.com/purchasetestapi/freights/export-csv', {
      responseType: 'blob',
    });
